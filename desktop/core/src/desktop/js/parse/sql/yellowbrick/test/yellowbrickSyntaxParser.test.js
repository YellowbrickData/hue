...
import yellowbrickSyntaxParser from '../yellowbrickSyntaxParser';

describe('yellowbrickSyntaxParser.js', () => {
  const expectedToStrings = function (expected) {
    return expected.map(ex => ex.text);
  };

  it('should not find errors for ""', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('', '');

    expect(result).toBeFalsy();
  });

  it('should report incomplete statement for "SEL"', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SEL', '');

    expect(result.incompleteStatement).toBeTruthy();
  });

  it('should report incomplete statement for "SELECT"', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SELECT', '');
  ...
  it('should not report incomplete statement for "SELECT * FROM tbl"', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SELECT * FROM tbl', '');

    expect(result.incompleteStatement).toBeFalsy();
  });

  it('should not report incomplete statement for "SELECT * FROM tbl LIMIT 1"', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SELECT * FROM tbl LIMIT 1', '');

    expect(result.incompleteStatement).toBeFalsy();
  });

  it('should report incomplete statement for "SELECT * FROM tbl LIMIT "', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SELECT * FROM tbl LIMIT ', '');

    expect(result.incompleteStatement).toBeTruthy();
  });

  it('should report incomplete statement for "SELECT * FROM tbl GROUP"', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SELECT * FROM tbl GROUP', '');
  ...
  it('should not report incomplete statement for "SELECT * FR"', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SELECT * FR', '');

    expect(result.incompleteStatement).toBeTruthy();
  });

  it('should find errors for "SLELECT "', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('SLELECT ', '');
  ...
  it('should find errors for "alter tabel "', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('alter tabel ', '');
  ...
  it('should find errors for "select *  form "', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('select *  form ', '');
  ...
  it('should find errors for "select asdf wer qwer qewr   qwer"', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('select asdf wer qwer qewr   qwer', '');
  ...
  it('should suggest expected that the statement should end for "use somedb extrastuff "', () => {
    const result = yellowbrickSyntaxParser.parseSyntax('use somedb extrastuff  ', '');
  ...
  const expectEqualIds = function (beforeA, afterA, beforeB, afterB) {
    const resultA = yellowbrickSyntaxParser.parseSyntax(beforeA, afterA);
    const resultB = yellowbrickSyntaxParser.parseSyntax(beforeB, afterB);
